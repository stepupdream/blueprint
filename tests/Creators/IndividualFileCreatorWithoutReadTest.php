...
/**
 * Class IndividualFileCreatorWithoutReadTest
 */
class IndividualFileCreatorWithoutReadTest extends TestCase
{
    /**
     * @test
     */
    public function individualFileCreatorWithoutRead(): void
    {
        $foundationAttributes = [
            'read_path'                => __DIR__.'/TestFiles/Yaml/',
            'output_path'              => __DIR__.'/TestResult/test2.php',
            'extension'                => 'php',
        ...
        $creator = $this->app->make(IndividualFileCreatorWithoutRead::class, [
